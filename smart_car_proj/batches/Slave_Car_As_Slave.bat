...
: for Outdoor, act as just Slave
:start D:\MobileRobots\Aria\examples\slave_car\bin\slave_car.exe -rp COM4 -rb 9600 -server 172.20.85.109 -sport 9998 -gps COM6 -sleepTime 5000 -slaveGpsTest 0 -delayGo 14000